...
namespace WarpCore
{
    ...
    public class FF(string resourceFolderPath)
    {
        private readonly string FFmpegPath = Path.Combine(resourceFolderPath, "ffmpeg.exe");
        private readonly string FFprobePath = Path.Combine(resourceFolderPath, "ffprobe.exe");
        private readonly string RubberbandPath = Path.Combine(resourceFolderPath, "rubberband.exe");
